...
function _capsule_info () {
  var autoapptime = '', html1 = '', html2 = '';

  var reqid   = document.getElementsByName('requesterId').length ? document.getElementsByName('requesterId')[0].value : null;
